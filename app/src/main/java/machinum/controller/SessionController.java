...
public class SessionController {
    ...
    public ScenarioResult startSession(@PathParam("id") String id, StartRequest request) {
        ...
        return instance.executeScript(request.script(), request.timeout());
    }
    ...
    record StartRequest(String script, int timeout) {}
    ...
    public static SessionController_ sessionController(Jooby application) {
        return new SessionController_(application.require(ContainerManagerService.class));
    }
